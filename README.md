...
<div class="nav" align="center">
  ...
  <a href="#-проекты">Технологии</a> |
  <a href="#-обучение">Установка</a> |
  <a href="#-сертификаты-нетологии">Локальный запуск</a> |
  <a href="#%E2%80%8D-о-себе">Тестовые пользователи</a> |
  <a href="#-контакты">Реализация</a> |
  <a href="#-контакты">Структура проекта</a> |
  <a href="#-контакты">UI и демонстрация</a> |
  <a href="#-контакты">Лицензия</a> |
  <a href="#-контакты">Автор</a>
</div>
