...
**Неткоин** - веб-приложение для управления внутренней валютой крипто-стартапа.  
...
- **Моя часть:** реализация клиентской логики, работа с API и обновление интерфейса
...
<div align='center'>
  <img width='700' src='assets/login-page.jpg' alt="Страница входа">
</div>
...
<div align='center'>
  <img width='700' src='assets/home-page.jpg' alt="Личный кабинет">
</div>
...
<div align='center'>
  <img width='400' src='assets/money-actions.gif' alt="Операции с балансом">
</div>
...
<div align='center'>
  <img width='700' src='assets/favorites.gif' alt="Избранные пользователи">
</div>
